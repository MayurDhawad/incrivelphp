...
include_once('config.php');
	...
	$query = "INSERT INTO user_contacts(contactuser_name, organization, user_email, website, mobileno, conatct_message, added_date) VALUES ('$user_name', '$company_name','$useremail', '$website', '$phoneno', '$message', '$added_date')";
